@extends('layouts.columns._ferry')
...
@section('script_b')
    <script>
        ...
        var quotes1 = [
                ...
                [
//                        http://www.jiemian.com/article/207013.html
                    {
                        c: '经常有人批评我们在这里开碧山书局，卖钱穆的书。但是农民难道就只配看《科学种田》吗？书店里经常有老人看一些很深的学术书，有个老人在看张柠研究乡村时间的书，还有老太太看《农民为什么离开土地》。我们对农民的想像太单一了。',
                        f: '欧宁',
                        z: 1
                    },
                    {
                        c: '我的家在大山里，我和另外三个同学到东部一所中学。城里同学对我们很客气，有的甚至给我们钱，或买东西送我们。虽然嘴上表示感谢，可我们三人都觉得被伤害了，他们慈善家一般的态度，让我们有种自己是叫花子的感觉。一周的体验结束后，我们急不可待地“逃”回了家。',
                        f: '祝保全',
                    }
                ],
                [
                    {
                        c: '我们一直很注意在各方面鼓励圆圆，但只给她精神鼓励，几乎没动用过物质奖励。在学习上更是执行“不奖励”政策。当然也有“考坏了不批评”的政策配套。她考好考坏都是正常的，不会因为她考好了我们就兴高采烈，考不好就生气失望。',
                        f: '尹建莉',
                        z: 1
                    },
                    {
                        c: '扬州一位妈妈这样奖励孩子学习：「数学考95分以上，出去旅游，语文考95分以上，同意买小狗，两门都在95分以上，奖励自由支配基金800元，两门在90分以上，可以自由选择上兴趣班。」',
                        f: '扬州晚报',
                    }
                ],
                ...
                [
                    {
                        c: 'Tony Hawken 满足于平价酒，从慈善书店买书，不喜欢高级名牌服装，他认为她妻子的生活铺张奢侈毫无必要。',
                        f: 'The Times',
                        z: 1
                    },
                    {
                        c: '一位购买高仿产品的网友说：哥买的不是纸袋，而是身份、心情和面子。',
                        f: '中国青年报',
                    }
                ],
                [
