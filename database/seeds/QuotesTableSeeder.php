...
Don\'t be a victim 已成美囶人共识。它的意思不是要人去和人争和人斗，而是在任何关系里面，不老是把自己放在「受害人」的角色之下。它相信人每一步皆有个体选择的自由，而不是等着他人来改变、解救自己。',
                ...
                '_place' => [
                    ...
                    'info' => [
                        'title' => '外贸逆差越来越大 清帝开始处理',
                        'intro' => '林则徐主张禁烟，不怕得罪参与鸦片贸易的权臣和水师，招待“英夷”更是热情而火辣：围困旅馆断水断粮、连坐制（甘结）、军力威胁、割英人耳朵并强迫对方吃下去。而英方官员义律也不是怨天尤人之辈，他执意践守他的西方司法标准和人权标准，被赶到海上了没淡水？接雨水喝；英船私自入关贸易？开炮逼回。而林哄皇上积极老练，下台更无怨言。他的强硬派好友也不是口炮党，用天朝方式果断出招：扫荡英人墓地把尸首扔到海里喂鱼，对俘虏实施游街和凌迟处死。越闹越大的冲突中，参与方没人沉溺于受害者情结，没人谈什么屈辱，没人做怨妇，都在揣摩、谋划、尽责，劳心使力。',
                        'relation' => false,
                    ]
                ],
            ...
            [
                ...
                'order' => $column_no_start,
                'title' => '不接受命运的青年，偷偷逃出家乡',
                'slug' => 'Tubman-liberty-or-death',
                'body' =>
                    '只能被奴役吗？ 自由北方的存在告诉 Tubman ,人生还有其它选择，但需要她以生命做注。1849 年，眼看要被女主人卖出偿债，Tubman 拒绝丈夫的劝阻，只身逃亡。路上得到废奴主义者和贵格会教徒的帮助，她成功逃到北方。Tubman 说："[T]here was one of two things I had a right to, liberty or death; if I could not have one, I would have the other." 此后，她加入北方的救助奴隶组织，多次潜回南方，带领奴隶投奔自由的北方。',
                'author' => '方柏林',
                'origin' => '',
                'origin_date' => '2015/09/08',
                'show_date' => false,
                ...
                '_place' => [
                    ...
                    'info' => [
                        'title' => '在这里长大',
                        'intro' => '有吃有喝有穿，但她要另外一种生活，一种命运不被人摆布的生活，宁愿以生命为代价。',
                        'relation' => true,
                    ]
                ],
...
//            ],
        ...
        $items = array_merge($items, [
            [
                ...
                'order' => $column_no_start,
                'title' => '汉语起源于叶尼塞河流域(Енисе́й)',
                'slug' => 'Chinese-Yenisei',
                'year' => -50000,
                'sig' => 0,
                'desc' => '古汉语朗读「所谓伊人，在水一方」，很想俄语，为什么？',
                'body' => '叶尼塞河发于贝加尔湖，流入北冰洋。西伯利亚在末冰期之后比现在暖和很多，跟河南差不多。叶尼塞流域是西西伯利亚平原和中西伯利亚高原的结合部，算是亚欧的分界地带，二战时德日计划到此汇合。在蛮荒年代，一些叶尼塞河居民的后裔进入中原，带来了汉语，而原住民逐渐接受了拓殖者的语言，和原有发音融合，形成了不同的方言（类似南美洲广泛使用西班牙语）。
...
对腐败的不满导致 1978 年爆发革命。当时所有的西方知识分子都说，这是在赶走暴君。美国政府错误地放弃支持独裁者巴列维，霍梅尼搭乘法航专机回到德黑兰掌握了权力。
...
//                    'url' => 'https://pic2.zhimg.com/v2-6b87554d550bf91f0c6f2ee3f37df2ed_1200x500.jpg',
            ...
            [
                ...
                'year' => 1900,
                'sig' => -1,
                'desc' => '过去的北平，「满街都是屎尿」，直到八国联军吓跑统治者，开始有了干净的街巷，公共卫生由此艰难起程。',
