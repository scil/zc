    ...
    public function run()
    {
        ...
        $videos = [
            '碧海蓝天' => [
                ...
                'intro' => '热爱潜水的 Jacques，对大海一往情深，后来他爱上乔汉娜；他的朋友亚舍也精于潜水，同时对名誉非常看重。一次挑战潜水极限的比赛让他们重逢，生命与海洋之间的对话就此展开。',
                '_relations' => [
                    'vol' => [
                        'title' => 'Big blue',
                        'column_id' => $v_col_id,
...
//                        'slug' => 'The-Big-Blue--behind',
                        'body' => '本片倾注了导演吕克·贝松对大海深切的热恋和回忆，他 17 岁时因为事故而被迫告别潜水，20 多岁时遇到了本片主人公的原型 Jacques Mayol 。Mayol 1927 年出生在上海，在佛罗里达一家水族馆做潜水员结识海豚 Clown, 在向海豚的学习中形成了自己独特的人生哲学。1966 年他在赛事上结识 Enzo，两人的友谊和竞争由此开始。 Enzo 说「雅克是为海而生的，而我，还是需要陆地。」',
