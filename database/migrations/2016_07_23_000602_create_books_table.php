...
class CreateBooksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('books', function (Blueprint $table) {
            ...
            $table->bigInteger('volume_id')->unsigned()->nullable(); // 允许非vol的视频
            $table->enum('type',[
                'first',
                'normal',
...
//            $table->integer('volumn_id')->unsigned()->nullable();
            $table->bigInteger('order')->unsigned()->nullable(); // for version
            $table->bigInteger('book_id')->unsigned()->nullable(); // for version
            ...
            $table->bigInteger('tip_id')->unsigned()->nullable(); // for version
            $table->bigInteger('errata_id')->unsigned()->nullable(); // for version
